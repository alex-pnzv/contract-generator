...
class ComboboxAutocomplete(Entry, object):
    def __init__(self, master, list_of_items=None, autocomplete_function=None, callback=None, listbox_width=None,
                 listbox_height=7, ignorecase_match=False, startswith_match=True, vscrollbar=True, hscrollbar=True,
                 **kwargs):
    ...
    def _build_listbox(self, values):
        ...
        self._listbox = Listbox(listbox_frame, background="white", selectmode=tk.SINGLE, activestyle="none",
        ...
        if self._use_vscrollbar:
            vbar = Scrollbar(listbox_frame, orient=tk.VERTICAL, command=self._listbox.yview)
        ...
        if self._use_hscrollbar:
            hbar = Scrollbar(listbox_frame, orient=tk.HORIZONTAL, command=self._listbox.xview)
    ...
    def set_list_of_items(self, list):
