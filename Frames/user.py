...
class UserFrame():
    ...
    def init_user_frame(self,root,db):
        ...
        self.edrpou = ttkwidgets.autocomplete.AutocompleteEntry(self.edrpou_frame, completevalues=[])
        ...
        self.hide_user_info_btn = tk.Button(self.edrpou_frame, text="\u2BC5", command=self.hide_info, width="17", height="17",
                     image=self.null_image, compound="center",
                     highlightthickness=0, padx=0, pady=0)
        self.hide_user_info_btn.pack(side=tk.RIGHT, padx=padx, pady=(0,5))


        self.show_user_info_btn = tk.Button(self.edrpou_frame, text='\u2BC6', command=self.show_info, width="17", height="17",
                                            image=self.null_image, compound="center", highlightthickness=0, padx=0, pady=0)
