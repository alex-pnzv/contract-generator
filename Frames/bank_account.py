...
class BankAccountFrame(tk.Frame):
    ...
    def init_bank_account_frame(self, root):
        ...
        self.bank_account_name_label = tk.Label(self.bank_account_name_frame, text="Назва рахунку", width=14, anchor=tk.W)
        self.bank_account_name_label.pack(side=tk.LEFT,padx=padx,pady=pady)
        self.bank_account_name = ttkwidgets.autocomplete.AutocompleteEntry(self.bank_account_name_frame,completevalues=[])
